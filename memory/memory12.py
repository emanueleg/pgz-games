# ver 12
# contiamo anche i tentativi per il punteggio
...
def draw():
    ...
    screen.draw.text("Tentativi: " + str(tries), (30, 625), color="white", shadow=(1.0,1.0), scolor="black", fontsize=28)
...
def clicked_card(i):
    global deck, shown, removed, n_cards, tries
